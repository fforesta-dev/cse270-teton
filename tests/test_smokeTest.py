...
class TestSmokeTest:
    ...
    def test_joinPageDataEntry(self):
        ...
        self.driver.find_element(By.NAME, "fname").send_keys("Francesco")
        self.driver.find_element(By.NAME, "lname").click()
        self.driver.find_element(By.NAME, "lname").send_keys("Foresta")
        self.driver.find_element(By.NAME, "bizname").click()
        self.driver.find_element(By.NAME, "bizname").send_keys("Francesco Foresta")
